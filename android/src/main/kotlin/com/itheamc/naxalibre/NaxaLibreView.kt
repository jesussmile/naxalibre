...
import com.itheamc.naxalibre.parsers.NaxaLibreMapOptionsArgsParser
...
class NaxaLibreView(
     ...
     * If the activity matches the one associated with this view, it calls the _controller.setupListeners method
     ...
     * If the activity matches the one associated with this view, it calls the _controller.removeListeners method

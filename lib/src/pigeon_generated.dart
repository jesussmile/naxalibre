...
class NaxaLibreHostApi {
  ...
  Future<void> setGeoJsonData(String sourceId, String jsonString) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.naxalibre.NaxaLibreHostApi.setGeoJsonData$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
  ...
  Future<void> setGeoJsonUri(String sourceId, String uri) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.naxalibre.NaxaLibreHostApi.setGeoJsonUri$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
